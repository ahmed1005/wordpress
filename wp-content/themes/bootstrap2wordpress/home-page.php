...
get_header(); ?>
	...
	<section id="hero" data-type="background" data-speed="5">
	    <article>
	        <div class="container clearfix">
	            <div class="row">
	                <dive class="col-sm-5">
	                     <img src="img/logo-badge.png" alt="fitness image" class="logo" width="300" height="150">
	       	                </dive><!-- col -->
	                       <div class="col-sm-7 hero-text">
                           <h1>Fit 4 Ever</h1>
                           <p class="lead">Get fitter - Get stronger - Live healthier</p>
                           ...
                           <div id="DD-PT">
	                           ...
	                           <p><a class="btn btn-lg btn-danger" href="/" role="button">JOIN NOW &raquo;</a></p>
	                       </div><!-- col -->
    ...
    <div class="container">
       <div class="row">
           <div class="col-sm-8">
              <p class="lead"><strong>Join Us Now. </strong>A personal trainer can change your life! </p>
	...
	<section>
	   	...
	   	<div class="container">
			...
			<div class="section-header">
				<img src="img/icon-fitness.jpg" alt="Chart">
...
After following these principles imagine how absolutely incredible you can feel. If others can do it, so can you. Go for it!</p>
	...
	<section id="who-benefits">
		<div class="container">
			...
			<div class="section-header">
				<img src="img/why-pt.jpg" alt="Pad and pencil">
	...
	<section id="what-you-get">
		<div class="container">
			...
			<div class="section-header">
				<img src="img/fitness.png" alt="Rocket">
	...
	--------------------------------------------------------- -->
		...
		<div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <img src="img/confident.png" alt="Design">
                        ...
                        <br>
                            <br>
                            <img src="img/energy.png" alt="Code">
                            <br>
                            <br>				    
                            <h3>Energy</h3>
                        ...
                        <div class="col-sm-4">
                            <img src="img/active.png" alt="CMS">
                            <h3>Be Active</h3>
			...
			<div class="row">
				...
				<div class="col-sm-8 col-sm-offset-2">
					...
					<div class="row testimonial">
						<div class="col-sm-4">
							<img src="img/pauline.png" alt="Pauline">
						</div><!-- end col -->
						<div class="col-sm-8">
				<blockquote>Ahmed Always introduces himself asks if any injuries.
                   Warm up &amp; Cool down good
					...
					<div class="row testimonial">
						<div class="col-sm-4">
							<img src="img/pauline.png" class="img-circle" alt="pauline" > <!-- I used Bootstrap to circle the photo but not working -->
					...
					<div class="row testimonial">
						<div class="col-sm-4">
							<img src="img/pauline.png" alt="photo">
						</div><!-- end col -->
						<div class="col-sm-8">
...
He is always very friendly and happy, which is great and make me feel comfortable training.<cite>&mdash; Carolyn </cite>
					...
					<div class="row testimonial">
						<div class="col-sm-4">
							<img src="img/ernest.png" alt="photo">
						</div><!-- end col -->
						<div class="col-sm-8">
							<blockquote>
